...
class MyGlobalsClass:
    ...
    def GetTorrentClient(self):
        if self.TorrentClient is None:
            ...
            if Settings.TorrentClientName.lower() == "qbittorrent":
                from .Tool.Qbittorrent import Qbittorrent
                Settings.TorrentClientAddress = Settings.TorrentClientAddress, ':', Settings.TorrentClientPort
                self.TorrentClient = Qbittorrent(Settings.TorrentClientAddress, Settings.TorrentClientPort,
                                                 Settings.TorrentClientUsername, Settings.TorrentClientPassword)
            else:
